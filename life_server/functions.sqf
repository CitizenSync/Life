...
private[""_msg"",""_to""];
	...
	[[_msg,name player,5,mapGridPosition player,player],""TON_fnc_clientMessage"",independent,false] call life_fnc_MP;
...
compileFinal "
	...
	[[_msg,name player,1,mapGridPosition player,player],""TON_fnc_clientMessage"",true,false] call life_fnc_MP;
	[] call life_fnc_cellphone;
...
compileFinal "
	...
	[[_msg,name player,2,mapGridPosition player,player],""TON_fnc_clientMessage"",true,false] call life_fnc_MP;
	[] call life_fnc_cellphone;
	hint format[""You sent %1 a message: %2"",_to,_msg];
	ctrlShow[3017,true];
";
...
compileFinal "
	...
	[[_msg,name player,3,mapGridPosition player,player],""TON_fnc_clientMessage"",_to,false] call life_fnc_MP;
	[] call life_fnc_cellphone;
