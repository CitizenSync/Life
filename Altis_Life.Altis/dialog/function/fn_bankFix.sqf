...
//*************** Test Code bankFix//// altis_life.Altis > dialog > function ***************
/*
fn_bankFix.sqf
*/
private["_vault"];
_vault = _this select 0;
if(!(_vault getVariable["vault_open",false])) exitWith {hint localize "STR_Cop_VaultLocked"};
...
_vault setVariable["vault_open",false,true];
