class DeathScreen
{
	...
	class Controls
	{
		...
		class RespawnBtn : Life_RscButtonMenu
		{
			...
			colorBackgroundPressed[] = { 0.15,0.68,0.89,1 };
			class Attributes 
			{
				align = "center";
			};
		...
		{
			idc = 7303;
			colorBackground[] = {0.67,0.01,0,1};
			colorBackgroundFocused[] = {0.67,0.01,0,1}; // Focused fill color
			colorBackgroundHover[] = {0.67,0.01,0,1}; // Mouse hover fill color
			colorBackgroundPressed[] = {0.67,0.01,0,1};
			x = 0.9 * safezoneW + safezoneX;
