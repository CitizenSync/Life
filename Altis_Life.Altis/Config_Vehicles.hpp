	...
	*/
	...
	class reb_car {
		...
		vehicles[] = {
			...
			{ "I_Heli_Transport_02_F", 30000, "rebel" },
			{ "I_Heli_light_03_unarmed_F", 75000, "rebel" }
		};
	};
	...
	class civ_air {
		...
		vehicles[] = {
			...
			{ "I_Heli_Transport_02_F", 20000, "pilot" },
	...
	class cop_air {
		side = "cop";
		vehicles[] = {
			{ "B_Heli_Light_01_F", 75000, "coastguard" },
			{ "I_Heli_light_03_unarmed_F", 20000, "coastguard", {"life_coplevel", 3} },
			{ "O_Heli_Light_02_unarmed_F", 80000, "coastguard", { "life_coplevel", 3 } },
			{ "B_Heli_Transport_03_unarmed_F", 90000, "coastguard", { "life_coplevel", 3 } },
			{ "B_Heli_Transport_01_F", 200000, "coastguard", { "life_coplevel", 3 } }
		};
	};
	...
	class cop_airhq {
		...
		vehicles[] = {
			{ "B_Heli_Light_01_F", 75000, "coastguard" },
			{ "I_Heli_light_03_unarmed_F", 200000, "coastguard", {"life_coplevel", 3} },
			{ "O_Heli_Light_02_unarmed_F", 80000, "coastguard", { "life_coplevel", 3 } },
			{ "B_Heli_Transport_03_unarmed_F", 80000, "coastguard", { "life_coplevel", 3 } },
			{ "B_Heli_Transport_01_F", 200000, "coastguard", { "life_coplevel", 3 } }
		};
	};
