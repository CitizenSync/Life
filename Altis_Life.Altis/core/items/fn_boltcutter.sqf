...
if((nearestObject [[16019.5,16952.9,0],"Land_Dome_Big_F"] OR [[20950,16856],"Land_i_Shop_01_V1_F"]) == _building OR (nearestObject [[16019.5,16952.9,0],"Land_Research_house_V1_F"]) == _building) then {
...
switch (typeOf _building) do {
	...
	case "Land_i_Shop_01_V1_F": {_cpRate =0.5;};
