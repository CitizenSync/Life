...
if(!(typeOf _vehicle in ["B_Quadbike_01_F","C_Hatchback_01_sport_F","C_Offroad_01_F","C_SUV_01_F","B_MRAP_01_F","B_Heli_Light_01_F","I_Heli_light_03_unarmed_F","O_Heli_Light_02_unarmed_F","B_Heli_Transport_03_unarmed_F","B_Heli_Transport_01_F"])) exitWith {}; //Last chance check to prevent something from defying humanity and creating a monster
