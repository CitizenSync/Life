...
*/
private ["_exempt"];
_exempt = ["Binocular","ItemWatch","ItemCompass","ItemGPS","ItemMap","NVGoggles","Medikit","FirstAidKit","ToolKit", "SmokeShell","SmokeShellRed","SmokeShellGreen","SmokeShellYellow","SmokeShellPurple","SmokeShellBlue","SmokeShellOrange","optic_ACO_grn","optic_Aco","optic_Aco_smg","optic_ACO_grn_smg","optic_Holosight","optic_Holosight_smg","optic_Hamr","optic_MRCO","optic_Arco"];
{
